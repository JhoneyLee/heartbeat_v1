...
DOCS_ACTIVITY_DATA_DIR = DOCS_DATA_DIR / "activities"
...
def publish_github_pages_assets() -> None:
    DOCS_DIR.mkdir(parents=True, exist_ok=True)
    DOCS_INDEX_HTML.write_text(DASHBOARD_HTML.read_text(encoding="utf-8"), encoding="utf-8")
    DOCS_NOJEKYLL.write_text("", encoding="utf-8")

    if DOCS_DATA_DIR.exists():
        shutil.rmtree(DOCS_DATA_DIR)
    shutil.copytree(REPORT_DATA_DIR, DOCS_DATA_DIR)
